...
export const Dashboard: React.FC = React.memo(() => {
  ...
  // Memoized recent appointments for better performance
            ...
            {QUICK_ACTIONS.map((action, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 p-2.5 lg:p-3 text-left rounded-lg transition-colors ${colorClasses[action.color]}`}
                >
